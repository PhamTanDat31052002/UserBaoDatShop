        ...
        <>
            ...
            <div class="header_section header_main">
                <div class="headerlink">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div className="logo " style={{ marginLeft: "30%", width: "25%" }}><NavLink to="/"><img src={require('../Assets/images/logo.png')} alt='' /></NavLink></div>
                        </div>
                                ...
                                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                                    <div className="containerHeader">
                                        <div className="itemHeader1">
                                            ...
                                            <NavLink to="/product" className="nav-item nav-link itemTask3" >Bộ sưu tập</NavLink>
                                                ...
                                                <div className="select-wrapper">
                                                    <div >
                                                        <ul className="ctnACHeader">
                                                            <li>
                                                                {/* <NavLink to="/account" className="far fa-user-circle nav-item nav-link itemTask2"
                                                                    style={{ fontSize: "32px" }}></NavLink>
                                                                <ul className="menuACHeaer">
                                                                    <li className="itemACHeader"> <NavLink onClick={() => {
                                                                        localStorage.clear()
                                                                        history("/")
                                                                    }}
